...
var ops = ['find', 'findOne', 'count', 'countDocuments', 'estimatedDocumentCount', 'distinct', 'findOneAndUpdate', 'findOneAndRemove', 'remove', 'update', 'deleteOne', 'deleteMany'];
...
_mongoose2.default.Aggregate.prototype.exec = jest.fn().mockImplementation(function cb(cb) {
  var modelName = this._model.modelName;


  var mock = mockingoose.__mocks[modelName] && mockingoose.__mocks[modelName].aggregate;
